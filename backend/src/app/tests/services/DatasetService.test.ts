...
describe("DatasetService", () => {
    ...
    beforeAll(async () => {
        ...
        const response = await fetch(`https://localhost:${Config.httpsPort}/api/v0/auth/login`, {
            agent: agent,
            method: "POST",
            body: body,
    ...
    afterAll(async () => {
        try { await new DatasetRepository(eds).delete({ guid: entityGuid }); }
    ...
    test("POST /api/v0/dataset - save new should return 200", async () => {
        ...
        const response = await fetch(Config.appUrl + "/api/v0/dataset", {
            agent: agent,
            method: "POST",
        ...
        let reloaded = await new DatasetRepository(eds).findOneByOrFail({ guid: entityGuid });
    ...
    test("GET /api/v0/datasets should return dataset list", async () => {
        ...
        const response = await fetch(Config.appUrl + "/api/v0/datasets", {
            agent: agent,
            method: "GET",
            headers: {
                "Content-Type": "application/json",
    ...
    test("GET /api/v0/dataset/:guid should return dataset and 200", async () => {
        ...
        const response = await fetch(Config.appUrl + "/api/v0/dataset/" + entityGuid, {
            agent: agent,
            method: "GET",
            headers: {
                "Content-Type": "application/json",
    ...
    test("DELETE /api/v0/dataset/:guid should delete dataset and return 200", async () => {
        ...
        let entity = await new DatasetRepository(eds).findBy({ guid: entityGuid });

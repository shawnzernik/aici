...
FROM "lists"
ORDER BY "title"
', '/static/tre/pages/list.html', 'false'),
...
', '/static/tre/pages/menu.html', 'false'),
...
', '/static/tre/pages/securable.html', 'false'),
...
', '/static/tre/pages/group.html', 'false'),
...
', '/static/tre/pages/user.html', 'false'),
...
FROM "settings"
ORDER BY "key"
', '/static/tre/pages/setting.html', 'false'),
